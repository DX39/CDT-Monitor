...
- `dev` 分支：`ghcr.io/wang4386/cdt-monitor:dev`、`wang4386/cdt-monitor:dev`
- `main` 分支：`ghcr.io/wang4386/cdt-monitor:latest`、`wang4386/cdt-monitor:latest`
